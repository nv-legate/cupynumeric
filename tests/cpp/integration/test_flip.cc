...
{
  std::vector<std::map<int32_t, std::array<legate::Complex<float>, 12>>> expect_result = {
    {{0,
...
void flip_basic()
{
  ...
  std::array<legate::Complex<float>, 12> in_array3 = {legate::Complex<float>(10, 3),
                                                      ...
                                                      legate::Complex<float>(7.9, 12),
                                                      legate::Complex<float>(6, 4)};
  std::array<legate::Complex<float>, 12> expect_result3;
  std::reverse_copy(in_array3.begin(), in_array3.end(), expect_result3.begin());
  test_flip_none_axis<legate::Complex<float>, 12>(
...
void flip_single_axis()
{
  ...
  test_flip_each_axis<legate::Complex<float>, 12>(
    test_shapes, in_array3, expect_result3, legate::complex64());
}
...
void flip_large_array()
{
  ...
  test_flip<legate::Complex<float>, count, 1>(
    in_array3, expect_val3, legate::complex64(), test_shape);
}
