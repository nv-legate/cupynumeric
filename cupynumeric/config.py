...
class _CupynumericSharedLib:
    ...
    CUPYNUMERIC_HISTOGRAM_NOWEIGHT: int
    CUPYNUMERIC_HISTOGRAM_WEIGHTED: int
    ...
    CUPYNUMERIC_NDIMAGE_CONVOLVE: int
    CUPYNUMERIC_NDIMAGE_CONVOLVE_CONSTANT: int
    CUPYNUMERIC_NDIMAGE_CONVOLVE_MIRROR: int
    CUPYNUMERIC_NDIMAGE_CONVOLVE_NEAREST: int
    CUPYNUMERIC_NDIMAGE_CONVOLVE_REFLECT: int
    CUPYNUMERIC_NDIMAGE_CONVOLVE_WRAP: int
    CUPYNUMERIC_NDIMAGE_FOURIER_FILTER: int
    CUPYNUMERIC_NONZERO: int
    CUPYNUMERIC_PACKBITS: int
    CUPYNUMERIC_PAD: int
    CUPYNUMERIC_POTRF: int
    CUPYNUMERIC_POTRS: int
...
class CuPyNumericOpCode(IntEnum):
    ...
    HISTOGRAM_NOWEIGHT = _cupynumeric.CUPYNUMERIC_HISTOGRAM_NOWEIGHT
    HISTOGRAM_WEIGHTED = _cupynumeric.CUPYNUMERIC_HISTOGRAM_WEIGHTED
    ...
    NDIMAGE_CONVOLVE = _cupynumeric.CUPYNUMERIC_NDIMAGE_CONVOLVE
    NDIMAGE_FOURIER_FILTER = _cupynumeric.CUPYNUMERIC_NDIMAGE_FOURIER_FILTER
    ...
    POTRS = _cupynumeric.CUPYNUMERIC_POTRS
    ...
    SCATTER = _cupynumeric.CUPYNUMERIC_SCATTER
    ...
    VANDER = _cupynumeric.CUPYNUMERIC_VANDER
...
@unique
class NdimageConvolveModeCode(IntEnum):
    CONSTANT = _cupynumeric.CUPYNUMERIC_NDIMAGE_CONVOLVE_CONSTANT
    MIRROR = _cupynumeric.CUPYNUMERIC_NDIMAGE_CONVOLVE_MIRROR
    NEAREST = _cupynumeric.CUPYNUMERIC_NDIMAGE_CONVOLVE_NEAREST
    REFLECT = _cupynumeric.CUPYNUMERIC_NDIMAGE_CONVOLVE_REFLECT
    WRAP = _cupynumeric.CUPYNUMERIC_NDIMAGE_CONVOLVE_WRAP
