...
enum CuPyNumericOpCode {
  ...
  CUPYNUMERIC_GEEV,
  CUPYNUMERIC_GEMM,
  CUPYNUMERIC_HISTOGRAM_NOWEIGHT,
  CUPYNUMERIC_HISTOGRAM_WEIGHTED,
  ...
  CUPYNUMERIC_ALL2ALL_SCATTER,
  CUPYNUMERIC_NDIMAGE_CONVOLVE,
  CUPYNUMERIC_NDIMAGE_FOURIER_FILTER,
  CUPYNUMERIC_NONZERO,
...
enum CuPyNumericNdimageConvolveMode {
  CUPYNUMERIC_NDIMAGE_CONVOLVE_CONSTANT,
  CUPYNUMERIC_NDIMAGE_CONVOLVE_MIRROR,
  CUPYNUMERIC_NDIMAGE_CONVOLVE_NEAREST,
  CUPYNUMERIC_NDIMAGE_CONVOLVE_REFLECT,
  CUPYNUMERIC_NDIMAGE_CONVOLVE_WRAP,
};
