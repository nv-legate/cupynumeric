...
struct NdimageConvolveImplBody<VariantKind::CPU, VAL, DIM, BATCHED> {
...
/*static*/ void NdimageConvolveTask::cpu_variant(TaskContext context)
{
  ndimage_convolve_template<VariantKind::CPU>(context);
}

namespace  // unnamed
{
static const auto cupynumeric_reg_task_ = []() -> char {
  NdimageConvolveTask::register_variants();
  return 0;
}();
}  // namespace
