...
struct NdimageFourierFilterImplBody<VariantKind::OMP, VAL, DIM> {
  TaskContext context;
...
/*static*/ void NdimageFourierFilterTask::omp_variant(TaskContext context)
{
  ndimage_fourier_filter_template<VariantKind::OMP>(context);
}
