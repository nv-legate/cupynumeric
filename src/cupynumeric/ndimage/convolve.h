...
class NdimageConvolveTask : public CuPyNumericTask<NdimageConvolveTask> {
 public:
  static inline const auto TASK_CONFIG =
    legate::TaskConfig{legate::LocalTaskID{CUPYNUMERIC_NDIMAGE_CONVOLVE}};

  static constexpr const char* ERROR_MESSAGE =
    "cupynumeric.ndimage.convolve is not implemented yet";
